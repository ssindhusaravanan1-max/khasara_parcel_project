...
## Workflow
- Georeferencing base map
- Parcel digitization
- Geometry check & repair
- Topology validation (gaps/overlaps)
- Labeling Khasra numbers
- Final layout export (PDF)
...
- [Download Workflow Report](Documents/Khasra_project_workflow.pdf)
